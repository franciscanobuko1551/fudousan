...
2026-06-15時点では、Phase 0.5の実装・検証条件は概ね完了し、Phase 1正式移行に向けて規約導線、回答品質レビュー、異常系確認を [docs/phase-1-readiness.md](docs/phase-1-readiness.md) に整理しています。
...
- 画面上から利用規約、プライバシーポリシー、免責文言の下書きを確認できます。
